...
CORE_BATCH=(1 2 4 8 16 20)
SMALL_BATCH=(1 2 4 8)
for cores in "${CORE_BATCH[@]}"
do
...
#MON_PID=$!
#sleep 0.5
./execImc.sh 10 2 $i 2>$LOG_DIR/$i-imc-log
#kill -INT $MON_PID
...
#MON_PID=$!
#sleep 0.5
./execFace.sh 10 2 $i 2>$LOG_DIR/$i-face-log
#kill -INT $MON_PID
...
#MON_PID=$!
#sleep 0.5
./execDig.sh 10 2 $i 2>$LOG_DIR/$i-dig-log
#kill -INT $MON_PID
